...
public class TemplateTree implements Serializable {
  ...
  public interface Observer {
    void onUpdate(TemplateTree templateTree);
  }
  ...
  /**
   * An observer to receive callbacks whenever this {@link TemplateTree} is updated.
   */
   ...
   * @param tId
   */
  public TemplateTree(String name, int tId) {
    assert GWT.isClient();
    this.name = name;
    this.tId = tId;
  }
   ...
   *
   * @param model
   *          the model that owns this {@link TemplateTree}
   */
   ...
   */
  TemplateTree update(Date lastUpdatedAt) {
    this.lastUpdatedAt = lastUpdatedAt;
   ...
   * @return <code>this</code>, for chaining purposes
   */
  TemplateTree update(TemplateTree templateTree) {
    if (!templateTree.getLastUpdatedAt().equals(lastUpdatedAt)) {
      id = templateTree.id;
      code = templateTree.code;
      name = templateTree.name;
      desc = templateTree.desc;
      tId = templateTree.tId;
      flags = templateTree.flags;
      rank = templateTree.rank;
      userId = templateTree.userId;
      lastUpdatedAt = templateTree.lastUpdatedAt;
      if (observer != null) observer.onUpdate(this);
    }
    return this;
  }

  TemplateTree update(int id, String code, Date lastUpdatedAt) {
    this.id = id;
    this.code = code;
    this.lastUpdatedAt = lastUpdatedAt;
